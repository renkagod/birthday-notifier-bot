...
async def check_birthdays(bot):
    ...
    for user_id, name, bday_str, tg_username in birthdays:
        try:
            ...
            notifications = {
                10080: f"🔔 <b>Через неделю</b> ({bday_str}) день рождения у {display_name}! Исполнится <b>{age}</b>.",
                4320: f"🔔 <b>Через 3 дня</b> день рождения у {display_name}! Исполнится <b>{age}</b>.",
                1440: f"🔔 <b>Завтра</b> день рождения у {display_name}! Исполнится <b>{age}</b>.",
                30: f"⏳ <b>Через 30 минут</b> день рождения у {display_name}! Исполнится <b>{age}</b>. Пора готовить поздравления!",
                5: f"🔥 <b>Через 5 минут</b> день рождения у {display_name}! Исполнится <b>{age}</b>.",
                0: f"🥳 <b>УРА! Сегодня {display_name} исполняется {age}!</b> Поздравь именинника! 🎉"
            }
